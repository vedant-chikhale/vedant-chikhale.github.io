  ...
  (n.xs_nav = function (a, t) {
      ...
      (r.init = function () {
        (r.settings = n.extend({}, o, t)),
          ...
          "right" == r.settings.offCanvasSide &&
            n(a).find(".nav-menus-wrapper").addClass("nav-menus-wrapper-right"),
          r.settings.hidden &&
    ...
    (r.showOffcanvas = function () {
      ...
      (r.toggleOffcanvas = function () {
        C() <= r.settings.mobileBreakpoint &&
          (n(a).find(".nav-menus-wrapper").hasClass("nav-menus-wrapper-open")
            ? (r.hideOffcanvas(), t !== s && r.callback("onHideOffCanvas"))
            : (r.showOffcanvas(), t !== s && r.callback("onShowOffCanvas")));
      }),
      (r.toggleSearch = function () {
        "none" == n(a).find(".nav-search").find("form").css("display")
          ? (n(a).find(".nav-search").find("form").fadeIn(200),
            n(a).find(".nav-search").find("input").focus())
          : (n(a).find(".nav-search").find("form").fadeOut(200),
      ...
      (r.initxs_navMode = function (e) {
        r.settings.responsive
          ? (e <= r.settings.mobileBreakpoint &&
              ...
              (n(a).addClass("xs_nav-portrait").removeClass("xs_nav-landscape"),
              S(),
              t !== s && r.callback("onPortrait")),
            e > r.settings.mobileBreakpoint &&
              d <= r.settings.mobileBreakpoint &&
              (n(a).addClass("xs_nav-landscape").removeClass("xs_nav-portrait"),
              k(),
              b(),
              r.hideOffcanvas(),
    ...
    var g = function () {
      ...
      w = function (e) {
        "landscape" == e
          ? n(a).find(".nav-menu").find("li, a").off(l)
          : n(a).find(".nav-menu").find("li, a").off(c).off(f);
      },
      O = function () {
